...
public enum Phase30ParityMatrixBuilder {
    public static func build() -> ParityMatrix {
        let specs: [(String, String, ParityStatus, String, String, String, String, String, String)] = [
            ...
            ("UI/platform", "performance with large servers", .partial, "Lazy member list and selected-server hydration", "Phase 68 makes identity merges idempotent and member invalidation server-scoped", "The repaired 2,324-member capture and settled CPU/memory proof remain pending", "Member perf, Phase 59 shell, and Phase 68 token tests", "Exercise the large server and verify grouping advances only for relevant changes", "Phase 68 live interaction re-test"),
            ...
            ("UI/platform", "diagnostics", .done, "Developer Verification", "Redacted diagnostics plus Phase 68 no-op, member invalidation, emoji-index, and coalesced-build counters", "Developer-only by design", "Redaction and Phase 60/68 coalescing tests", "Copy diagnostics", "Keep safe"),
