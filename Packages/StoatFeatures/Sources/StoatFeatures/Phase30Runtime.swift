...
public enum Phase30ParityMatrixBuilder {
    public static func build() -> ParityMatrix {
        let specs: [(String, String, ParityStatus, String, String, String, String, String, String)] = [
            ...
            ("Core chat", "reactions", .partial, "Verified reaction routes", "Common reactions plus Phase 57 full-width row access", "Live hit-target and custom emoji reaction audit pending", "Reaction and Phase 57 action tests", "Right-click row whitespace and react", "Phase 57/48 live audit"),
            ...
            ("Core chat", "user/avatar hydration", .partial, "Ready/member REST/message/profile data", "Phase 56 retains sparse-gateway overlays; Phase 57 adds visibility-driven loading and decoded-cache continuity", "Post-send avatar and idle CPU re-test pending", "Resolver plus Phase 56/57 cache tests", "Send repeatedly and inspect large server", "Keep partial until Phase 57 QA"),
            ...
            ("UI/platform", "performance with large channels", .partial, "Lazy timeline and bounded media", "Phase 57 removes render-triggered loads and scopes media invalidation", "Sustained idle CPU re-test needed", "Timeline/media plus Phase 56/57 tests", "Warm channel then idle and sample", "Phase 57 live performance gate"),
            ("UI/platform", "performance with large servers", .partial, "Lazy member list and selected-server hydration", "Phase 57 uses visibility-driven avatar loading and visible-key-aware eviction", "2,324-member idle CPU re-test needed", "Member perf plus Phase 56/57 tests", "Repeat large-server idle sample", "Phase 57 live performance gate"),
