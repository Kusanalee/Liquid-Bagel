...
public enum Phase30ParityMatrixBuilder {
    public static func build() -> ParityMatrix {
        let specs: [(String, String, ParityStatus, String, String, String, String, String, String)] = [
            ...
            ("Core chat", "server text channels", .partial, "Ready channels and channel messages", "Phase 56 provides immediate capped-history grouping for select/load/send", "Round-3 live send and channel-switch fix needs confirmation", "Message load/send and Phase 56 immediate-paint tests", "Send without leaving; switch rapidly", "Phase 56 live re-test"),
            ...
            ("Core chat", "send/edit/delete messages", .partial, "Verified channel message routes", "Send/edit/delete plus observable optimistic/confirmed timeline paint", "Round-3 live send regression fix needs confirmation", "Message action and Phase 56 send-paint tests", "Send without channel re-entry", "Phase 56 live re-test"),
            ...
            ("Core chat", "user/avatar hydration", .partial, "Ready/member REST/message/profile data", "Phase 56 retains sparse-gateway user overlays and defers missing avatar reloads", "Large-server/avatar recovery needs live confirmation", "Resolver plus Phase 56 overlay/avatar tests", "Inspect large server and chats", "Keep partial until live QA"),
            ...
            ("UI/platform", "performance with large channels", .partial, "Lazy timeline and bounded media", "Phase 56 adds immediate capped grouping, media retry, and poster budgets", "Round-3 live confirmation needed", "Timeline/media/Phase 56 tests", "Run channel/media checklist", "Phase 56 live performance gate"),
            ("UI/platform", "performance with large servers", .partial, "Lazy member list and selected-server hydration", "Phase 56 retains users and requeues avatars without broad fetching", "2,324-member live confirmation needed", "Member perf and Phase 56 tests", "Repeat large-server sample", "Phase 56 live performance gate"),
