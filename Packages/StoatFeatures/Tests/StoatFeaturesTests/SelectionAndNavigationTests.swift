...
extension StoatFeaturesTests {
    ...
    func testInvalidSelectedChannelFallsBackSafely() {
        ...
        let model = MainShellViewModel(
            ...
            snapshot: TestShellData.snapshot, runtimeMode: .mock, sessionState: .mock, currentUser: TestShellData.snapshot.usersByID[TestShellData.currentUserID], messageActionHandler: StubMessageActionHandler(currentUserID: TestShellData.currentUserID), communityAPIClient: StubStoatAPIClient())
